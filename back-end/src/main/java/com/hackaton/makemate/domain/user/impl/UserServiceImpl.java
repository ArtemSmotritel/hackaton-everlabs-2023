...
public class UserServiceImpl implements UserService {
    ...
    public UserServiceImpl(UserRepository userRepository, UserMatcher userMatcher,
    ...
    private Interest fetchInterestById(Long interestId) {
        return interestRepository.findById(interestId)
                .orElseThrow(
                        () -> new BadRequestException(String.format("Interest with id %s doesn't exist", interestId)));
    }
